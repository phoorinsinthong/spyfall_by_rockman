...
const DEFAULT_LOCATIONS = {
  ...
  'โรงพยาบาล': ['หมอ','พยาบาลมือเบา','ศัลยแพทย์','คนไข้อาการหนัก','พนักงานเข็นเตียง','คนกลัวเข็มจนสลบ','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ชายหาด': ['ไลฟ์การ์ด','นักเซิร์ฟ','คนทาครีมกันแดดวอก','แม่ค้าส้มตำ','คนห่วงยางแตก','แก๊งค์ปาร์ตี้ริมหาด','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'คาสิโน': ['ดีลเลอร์','รปภ.หน้าโหด','นักพนันหมดตัว','แจกไพ่ผิด','เสี่ยกระเป๋าหนัก','คนมาดูเฉยๆ','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'เครื่องบิน': ['นักบินพักผ่อนน้อย','แอร์โฮสเตสสุดเป๊ะ','ผู้โดยสารเมาเครื่องบิน','เด็กร้องไห้ 8 หลอด','กัปตัน','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร','พนักงานฝึกหัด'],
  'โรงเรียน': ['ครูฝ่ายปกครอง','นักเรียนโดดเรียน','ครูใหญ่ใจดี','ภารโรงรู้ทุกเรื่อง','ประธานนักเรียนเนิร์ด','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร','พนักงานฝึกหัด'],
  'หมูกระทะ': ['พนักงานเปลี่ยนเตา','คนแย่งตักกุ้ง','โต๊ะข้างๆ กินจุมาก','สายถ่ายรูปไม่เน้นกิน','เจ้าของร้าน','นักร้องสู้ชีวิต','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'วัดป่า': ['เจ้าอาวาส','เด็กวัด','มัคนายกขาประจำ','คนขายลอตเตอรี่','สัปเหร่อ','คุณป้าสายบุญ','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'สถานีตำรวจ': ['ร้อยเวร','ผู้ต้องหา','ญาติผู้ต้องหา','ทนายความ','สายสืบนอกเครื่องแบบ','นักข่าวช่องดัง','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ร้านนวดแผนไทย': ['หมอนวดจับเส้น','ลูกค้าบ้าจี้','คนเฝ้าเคาน์เตอร์','ลูกค้าหลับกรนเสียงดัง','ฝรั่งมาลองนวดครั้งแรก','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร','พนักงานฝึกหัด'],
  // สถานที่ใหม่ 20 แห่ง
  'ตลาดนัด': ['พ่อค้าต่อราคาเก่ง','แม่ค้าไม่ลดแล้ว','คนงงราคา','คนแบกของหนัก','โจรล้วงกระเป๋า','คนตามหาของถูก','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ร้านสะดวกซื้อ': ['แคชเชียร์ง่วงนอน','ลูกค้าซื้อบุหรี่กลางดึก','เด็กกินซาลาเปาหน้าร้าน','พนักงานไล่ให้ออก','คนมาขอชาร์จโทรศัพท์','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร','พนักงานฝึกหัด'],
  'สนามฟุตบอล': ['กองหน้าขิงมาก','กองหลังไม่วิ่ง','ผู้รักษาประตูมือใหม่','กองเชียร์ดังลั่น','ผู้ตัดสินโดน욕','คนขายน้ำข้างสนาม','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ห้างสรรพสินค้า': ['พนักงานขับรถเข็น','แม่บ้านโปรโมชั่น','เด็กวิ่งหายในห้าง','คนต่อคิวฟู้ดคอร์ต','คนหาที่จอดรถไม่เจอ','พนักงานต้อนรับตึง','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'สวนสัตว์': ['ผู้ดูแลสัตว์','เด็กขว้างอาหารใส่ลิง','คนกลัวงู','ไกด์นำเที่ยวเสียงดัง','คนซื้อลูกโป่งแล้วหายไป','ช่างภาพสัตว์ป่า','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ค่ายทหาร': ['นายพล','ทหารเกณฑ์ปีแรก','จ่าโหด','พลทหารหลับยืน','แม่ทัพ','พ่อครัวทหาร','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ร้านอาหารหรู': ['เชฟมิชลิน','เสิร์ฟไวน์ผิดโต๊ะ','ลูกค้าอินสตาแกรม','คนกินครั้งแรกในชีวิต','โซมเมลิเย่','เด็กร้านขัดรองเท้า','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ยิม': ['เทรนเนอร์แน่นมาก','คนยกเวทตะโกน','คนเดินสายพานดูโทรศัพท์','สาวเซลฟี่ทุก 5 นาที','คนขโมยที่นั่งพัก','คนเช็ดเหงื่อใส่เครื่อง','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'สนามบิน': ['พนักงานเช็คอิน','คนสายเครื่องตก','เจ้าหน้าที่ตรวจหนังสือเดินทาง','คนแพ็คกระเป๋าเกิน','ตำรวจตรวจศุลกากร','ผู้โดยสาร VIP','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'โรงภาพยนตร์': ['คนโทรศัพท์ไม่ปิดเสียง','คนทานป๊อปคอร์นเสียงดัง','พนักงานฉายหนัง','คู่รักแอบจูบกัน','คนตัวสูงนั่งหน้า','แม่พาลูกเข้าหนังผู้ใหญ่','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ตลาดปลา': ['พ่อค้าปลาตะโกน','คนซื้อปลาต่อราคา','แมวขโมยปลา','แม่ค้าทำน้ำปลาหก','คนแพ้กลิ่นปลา','ชาวประมง','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'โรงแรม 5 ดาว': ['คอนเซียร์จสุดเป๊ะ','แม่บ้านตรวจความสะอาด','แขกนักธุรกิจ','บาร์เทนเดอร์เลานจ์','คนลืมกุญแจห้อง','พนักงาน Spa','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ร้านเกม': ['เจ้าของร้านอ้วน','เด็กเล่น PUBG ด่าเพื่อน','คนทำเครื่องพัง','แม่มาตาม','คนหัดเล่นครั้งแรก','โปรเกมเมอร์ฝึกซ้อม','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ไนต์คลับ': ['ดีเจ','ซีเคียวริตี้ใหญ่โต','คนเมาสุดๆ','สาวไฮโซ VIP','บาร์เทนเดอร์มือเร็ว','คนเต้นสุดฮา','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ฟาร์มหมู': ['เกษตรกรสุดแกร่ง','สัตวแพทย์บ้านนอก','หมูแสนรู้','คนซื้อหมูส่งตลาด','ลูกหมูหนี','นักวิทยาศาสตร์เก็บตัวอย่าง','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ออฟฟิศ': ['ซีอีโอหน้าบึ้ง','พนักงานฝ่าย HR','เด็กฝึกงานงง','คนหลับในประชุม','คนล็อคหน้าจอไว้','แม่บ้านออฟฟิศรู้ทุกเรื่อง','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'คอนเสิร์ต': ['นักร้องดัง','สตาฟฟ์แบกอุปกรณ์','แฟนคลับกรี๊ดดัง','คนถ่ายวิดีโอตลอด','รปภ.ดันคนออก','คนซื้อตั๋วปลอม','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'สิ่งขนส่งสาธารณะ (BTS)': ['คนไม่ยอมขยับเข้าไป','นักเรียนแย่งที่นั่ง','คนฟังเพลงเสียงดัง','คนสวมหน้ากากมิดชิด','พ่อค้าขายของในรถไฟ','ตำรวจตรวจตั๋ว','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ตลาดนัดกลางคืน (Jodd Fair)': ['คนขายของวินเทจ','อินฟลูเอนเซอร์ถ่ายคอนเทนต์','คนหาที่จอดรถ 1 ชั่วโมง','พ่อครัวสตรีทฟู้ด','ดีเจเปิดเพลง','นักท่องเที่ยวต่างชาติ','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'สปา / อ่างน้ำร้อน': ['แพทย์ทางเลือก','ลูกค้าเครียดสุดๆ','พนักงานเจ้าของนิ้ว','คนหลับตลอด 2 ชั่วโมง','เซลล์ขายแพ็คเกจ','คนแพ้น้ำมันหอม','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  // 10 สถานที่ใหม่กวนๆ
  'ห้องน้ำสาธารณะ': ['คนเคาะประตูถี่มาก','คนกระดาษหมดพอดี','แม่บ้านถือไม้ม็อปจ้อง','คนโทรคุยในห้องน้ำ','คนลืมรูดซิป','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร','พนักงานฝึกหัด'],
  'งานแต่งงาน': ['เจ้าบ่าวตื่นเต้นจนเป็นลม','เจ้าสาวไม่มา','แขกกินบุฟเฟ่ต์ยกที่','DJ เปิดเพลงผิด','ป้าถ่ายรูปขวางช่างภาพ','แฟนเก่าแอบมา','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ร้านตัดผม': ['ช่างตัดผมมือสั่น','ลูกค้าโชว์รูปดาราแล้วผิดหวัง','เด็กร้องไห้ไม่ยอมตัด','คนรอนานจนหลับ','ช่างโกนหนวดหน้าตาเฉย','ลูกค้าบ่นไม่หยุด','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ห้องสอบ': ['นักเรียนลอกข้างๆ','อาจารย์คุมสอบง่วงนอน','คนเขียนจนหมดหน้ากระดาษ','คนส่งข้อสอบแล้วเดินออกมาดีใจ','คนลืมดินสอ','นักเรียนนั่งสั่นขาตลอด','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'รถเมล์ตีห้า': ['คนขับแข่งกับเวลา','ป้าแม่ค้าตะกร้าเต็มคัน','ลูกจ้างง่วงจนหัวทิ่ม','คนนับเหรียญค่าโดยสาร','กระเป๋ารถด่าทอด','คนวิ่งตามรถไม่ทัน','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ร้านขายยา': ['เภสัชกรถามซักประวัติยาว','ลูกค้าซื้อยาตามติ๊กต๊อก','คนซื้อถุงยางตาขวาง','คนมาขอยาแก้เมาค้าง','ลูกค้าแย้งว่าหมอสั่งผิด','คนซื้อวิตามินทั้งร้าน','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ค่ายดาวเทียม (Camp)': ['ผู้นำค่ายสุดฮาร์ดคอร์','น้องใหม่ร้องไห้คิดถึงบ้าน','คนกลัวแมลง','คืนแรกนอนไม่หลับ','แม่ทัพทีมเชียร์','คนแอบเอาโทรศัพท์มา','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ห้อง ICU': ['หมอทำหน้าตรึง','พยาบาลวิ่งทุก 5 นาที','ญาติร้องไห้หน้าห้อง','เครื่องบีบหัวใจดังตลอด','คนไข้แอบดูฟีด IG','นักศึกษาแพทย์ฝึกงาน','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ปาร์ตี้วันเกิด': ['เจ้าของวันเกิดร้องไห้โดนเซอร์ไพรส์','คนตัดเค้กแบ่งผิด','แขกที่ไม่ได้รับเชิญแต่มาเอง','คนเหล้าหมดก่อนทุกคน','ดีเจเปิดเพลงสปีดเร็วผิดงาน','คนถ่ายรูปแต่ไม่กิน','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
  'ราชวัง / พระบรมมหาราชวัง': ['นักท่องเที่ยวไม่รู้กฎการแต่งกาย','ไกด์เล่าประวัติศาสตร์ไม่หยุด','เจ้าหน้าที่ยืนนิ่งเหมือนหุ่น','คนแอบถ่ายรูปในเขตห้าม','แฟชั่นนิสต้าใส่ชุดสั้น','พระราชวงศ์เสด็จ','คนทำความสะอาด','ยามรักษาความปลอดภัย','ช่างซ่อมบำรุง','ลูกค้าขาจร'],
};

const NON_STANDARD_LOCATIONS = {
  'กกมง.กง.กห.': ['ผอ.','รอง ผอ.','พี่โย','โตน้อย','พี่เชียร','นิว','กัน','พี่นัท','คนทำความสะอาด','ยามรักษาความปลอดภัย'],
  'กจก.กง.กห.': ['ผอ.','รอง กอล์ฟ','รอง หญิง','พี่นัท','พี่โอ๋','พี่หนู','พี่ใหม่','โอปอ','พี่หมวย','คนทำความสะอาด']
};
...
function renderRoom(data) {
  ...
  if (data.status === 'PLAYING') {
    ...
    if (data.spyRevealing) {
      ...
      // Auto popup spy guess modal and hide cancel button if timer is null
      if (me.role === 'สายลับ' && data.spyRevealing === me.name) {
          if (document.getElementById('spy-reveal-modal').classList.contains('hidden')) {
              ...
              document.getElementById('spy-reveal-name-text').innerText = `คุณกำลังทายสถานที่!`;
              document.getElementById('spy-reveal-modal').classList.remove('hidden');
          }
          if (!data.timerEnd) {
              document.getElementById('btn-spy-cancel-reveal').classList.add('hidden');
          } else {
              document.getElementById('btn-spy-cancel-reveal').classList.remove('hidden');
          }
      }
    } else {
...
async function checkVotesEndGame() {
  ...
  if (allVoted && rData.status === 'VOTING') {
    ...
    let isSpyVotedOut = (targets.length === 1 && players[targets[0]].role === 'สายลับ');
    if (isSpyVotedOut) {
      await endGame('Players');
    } else {
      let spyName = '';
      for (let id in players) {
        if (players[id].role === 'สายลับ') spyName = players[id].name;
      }
      
      let updates = { status: 'PLAYING', spyRevealing: spyName, timerEnd: null };
      
      const chatRefKey = push(ref(db, `rooms/${STATE.roomId}/chat`)).key;
      updates[`chat/${chatRefKey}`] = { sender: 'ระบบ', text: `❌ โหวตผิดคน! สายลับตัวจริงคือ ${spyName} (กำลังทายสถานที่...)`, isSystem: true };
